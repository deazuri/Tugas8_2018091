...
import static com.example.tugasrecycleview.DBmain.TABLENAME;
...
public class TambahAlbum extends AppCompatActivity {
    private DrawerLayout dl;
    private ActionBarDrawerToggle abdt;
    private ActivityTambahAlbumBinding binding;
    DBmain dBmain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding =
                ActivityTambahAlbumBinding.inflate(getLayoutInflater());
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_alarm) {
                    Intent a = new Intent(TambahAlbum.this,
                            MainActivity.class);
                    startActivity(a);
                } else if (id == R.id.nav_message) {
                    Intent b = new Intent(TambahAlbum.this,
                            MainActivity1.class);
                    startActivity(b);
                } else if (id == R.id.nav_chat) {
                    Intent c = new Intent(TambahAlbum.this,
                            MainActivity2.class);
                    startActivity(c);
                } else if (id == R.id.nav_profile) {
                    Intent d = new Intent(TambahAlbum.this,
                            MainActivity3.class);
                    startActivity(d);
                }
                else if (id == R.id.nav_sql) {
                    Intent e = new Intent(TambahAlbum.this,
                            TambahAlbum.class);
                    startActivity(e);
                }
                return true;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new
                                                     View.OnClickListener() {
                                                         ...
                                                         public void onClick(View v) {
                                                             ...
                                                             if (rec != null) {
                                                                 Toast.makeText(TambahAlbum.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                                                                 ...
                                                                 Toast.makeText(TambahAlbum.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                                                             }
                                                         }
                                                     });
        //for view display
        binding.btnDisplay.setOnClickListener(new
                                                      View.OnClickListener() {
                                                          @Override
                                                          public void onClick(View v) {
                                                              startActivity(new Intent( TambahAlbum.this,
                                                                      DisplayData.class));
                                                          }
                                                      });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(TambahAlbum.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
